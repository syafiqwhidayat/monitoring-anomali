...
<div class="page-header d-print-none mb-2">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Log Upload Monitoring SE</h2>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($log['status'] == 'selesai'): ?>
                                        <button class="btn btn-outline-danger btn-sm btn-hapus-monitor"
                                            data-tanggal="<?= $log['created_at'] ?>" data-id="<?= $log['id'] ?>"
...
<div class="modal modal-blur fade" id="modalUpload" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?= base_url('se/store') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Monitoring SE2026</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p> Template Upload Monitoring SE2026 :</p>
                    <a href="<?= base_url('/se/downloadTemplate'); ?>" class="btn btn-outline-primary">
...
<div class="modal modal-blur fade" id="modalKonfirHapus" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?= base_url('/se/hapus') ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Konfirmasih Hapus Data Monitoring</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <span>Apakah Anda Yakin Data Monitoring Tanggal: </span>
                    <span id="display-tanggal" class="fw-bold">-</span>
...
<script>
    ...
    const hapusButton = document.querySelectorAll(".btn-hapus-monitor");
    hapusButton.forEach((button) => {
        button.addEventListener("click", function() {
            ...
            document.getElementById("display-tanggal").innerText = tanggal;
