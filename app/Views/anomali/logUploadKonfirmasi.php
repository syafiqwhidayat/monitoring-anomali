...
<div class="page-header d-print-none mb-2">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Log Import Konfirmasi Anomali</h2>
            </div>
...
<div class="modal modal-blur fade" id="modalUpload" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="<?= base_url('/anomali/store') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Konfirmasi Anomali</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p> Template Upload Anomali :</p>
                    <a href="<?= base_url('/anomali/rekap-anomali') ?>" class="btn btn-outline-primary">
                        Unduh Template Konfirmasi
                    </a>
                    <div class="hr-text"></div>
                    <div class="mb-3">
                        <label class="form-label">Pilih File (Excel/CSV)</label>
                        <input type="file" name="file_anomali" class="form-control" required>
                        <small class="form-hint mt-2">Upload excel akan menambahkan Konfirmasi Anomali Berdasarkan ID. Jika ada kendala upload konfirmasi silahkan hubungi super admin.</small>
                    </div>
                </div>
...
<script>
    function showError(id) {
        ...
        fetch('<?= base_url('/anomali/log-detil/') ?>' + id)
