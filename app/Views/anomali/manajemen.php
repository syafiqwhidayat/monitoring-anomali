                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?= base_url('/anomali/upload'); ?>" method="POST">
                                    ...
                                    <button type="submit" name="action" value="toogle" class="btn btn-primary p-1 d-flex align-items-center"><img src="<?= ($l['isSee']) ? '/img/icons/eye-slash.svg' : '/img/icons/eye.svg'; ?>" alt="Ikon Simpan" width="16" height="16"></button>
