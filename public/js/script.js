document.addEventListener('DOMContentLoaded', function () {
    ...
    if (parentAccordionKec) {
        ...
        parentAccordionKec.addEventListener('submit', function(event) {
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    feedbackElement.innerHTML = '<i class="text-success bi bi-check-circle-fill"></i> Saved!';
                    // Optional: Highlight baris yang sukses
                    form.classList.add('bg-success', 'bg-opacity-10'); 
                    setTimeout(() => form.classList.remove('bg-success', 'bg-opacity-10'), 2000); 
                } else {
            ...
            .catch(error => {
                ...
                feedbackElement.innerHTML = '<span class="text-danger">Koneksi Error.</span>';
