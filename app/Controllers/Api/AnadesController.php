...
class AnadesController extends BaseController
{
    use ResponseTrait;
    ...
    public function uploadCsv()
    {
        ...
        $requiredColumns = ['kode_wilayah', 'kode_variabel', 'n_batas_bawah', 'n_rata'];
        ...
        $builder = $db->table('identifikasi_anades'); // Sesuaikan dengan nama tabel asli Anda
        ...
        return $this->respondCreated([
            'status'  => true,
            'message' => "Berhasil memproses (Murni \$db) sebanyak {$rowCount} baris data anades!",
        ]);
    }
}
